...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        l1.setBounds(405,155,250,35);
        l4.add(l1);
        
        l2.setBounds(300,220,150,35);
        l4.add(l2);
        
        l3.setBounds(300,270,200,35);
        l4.add(l3);
        
        t1.setBounds(485,225,190,30);
        l4.add(t1);
        
        t2.setBounds(485,275,190,30);
        l4.add(t2);
        
        b1.setBounds(285,365,175,35);
        l4.add(b1);
        
        b2.setBounds(535,365,175,35);
        l4.add(b2);
