...
public class Signup2 extends JFrame implements ActionListener{
    ...
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l15;
    JButton b,bOtp;
    ...
    Signup2(String formno){
        ...
        bOtp = new JButton("Send OTP");
        bOtp.setFont(new Font("Raleway", Font.BOLD, 14));
        bOtp.setBackground(Color.BLACK);
        bOtp.setForeground(Color.WHITE);
        ...
        bOtp.setBounds(690,440,120,30);
        add(bOtp);

        l15.setBounds(100,490,180,30);
        add(l15);

        t3.setBounds(350,490,320,30);
        add(t3);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(pan.trim().equals("") || aadhar.trim().equals("") || scitizen.equals("") || eaccount.equals("")){
                ...
                JOptionPane.showMessageDialog(null, "Please send OTP to verify Aadhar");
            }else if(!generatedOtp.equals(enteredOtp.trim())){
                JOptionPane.showMessageDialog(null, "Invalid Aadhar OTP");
            }else if(verifiedAadhar == null || !verifiedAadhar.equals(aadhar)){
                JOptionPane.showMessageDialog(null, "Aadhar number changed. Please send OTP again");
            }else{
                Conn c1 = new Conn();
    ...
    private void sendAadharOtp(){
        String aadhar = t2.getText().trim();
        if(!aadhar.matches("\\d{12}")){
            JOptionPane.showMessageDialog(null, "Enter a valid 12-digit Aadhar number before sending OTP");
            return;
        }
        ...
        t3.setText("");
        JOptionPane.showMessageDialog(null,
                "OTP sent to mobile number linked with Aadhar ending "
